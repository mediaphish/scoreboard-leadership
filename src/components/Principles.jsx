...
const principles = [
  ...
  { title: "Owner standard", text: "Clear single-point ownership with freedom in method, strictness in outcomes." },
  { title: "Honest rhythms", text: "Short, frequent inspect-and-improve cycles replace long, performative meetings." },
  { title: "One-page plays", text: "Every important effort fits on one page: purpose, owner, steps, risks, next review." },
